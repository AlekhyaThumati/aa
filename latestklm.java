    	        	...
    	        	//code for  choose a depaure filght link -- EUR...
		    	     ...
		    	     /*  WebElement img= driver.findElement(By.xpath("//*[@aria-label = 'Continue']"));
		    	      ...
		    	      //*[@id="brandedFaresWidgetContainer"]/div/div/div[3]/div[2]/div/ul/li[2]/div[1]/div/div
		    	        ...
		    	        // 2nd page continue --we can see here back and continue buttons
		    	   	 ...
		    	   	 //  month.sendKeys(s.getCell(2,8).getContents());
		    	   	  ...
		    	   	  // year.sendKeys(s.getCell(3,8).getContents());
		    	   	   year.sendKeys("1988");
		    	   	     ...
		    	   	     driver.findElement(By.id("passengerField_1000_emailAddress")).sendKeys(s.getCell(8,i).getContents());
		    	   	     //sendKeys("thumatialekhya@gmail.com");
		    	   	     //sendKeys(s.getCell(1,10).getContents());
		    	   	     Thread.sleep(3000);
		    	   	    driver.findElement(By.id("passengerField_1000_phoneNumberFirst")).sendKeys(s.getCell(9,i).getContents());
		    	   	  //  sendKeys("657764287");
 ...
 * 
 * Continue 
 * /html/body/div[6]/div/div/div/div[1]/div/div[1]/ul/li[5]/button[1]
 * 
 * //div[@class='g-search-form--connections']//div[1]//label[1]//input[1]
 * element_enter.sendKeys(Keys.RETURN);
 * First: driver.findElement(By.id("idValue")).sendKeys(Keys.ENTER);
Seconxd:
